# <a name="insert-excel-charts-using-microsoft-graph-in-a-powerpoint-add-in"></a>Einfügen von Excel-Diagrammen mit Microsoft Graph in einem PowerPoint-Add-In 
