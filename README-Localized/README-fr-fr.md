# <a name="insert-excel-charts-using-microsoft-graph-in-a-powerpoint-add-in"></a>Insérer des graphiques Excel à l’aide de Microsoft Graph dans un complément PowerPoint 
